  ...
  SELECT
    ...
    cfde_keywords_merge(
      ...
      (SELECT cfde_keywords_merge(
         ...
         cfde_keywords_agg(dis2.id, dis2.name, dis2.description),
         cfde_keywords_merge_agg(dis2.synonyms)
       )
      ...
      (SELECT cfde_keywords_merge(
         ...
         cfde_keywords_agg("at2".id, "at2".name, "at2".description),
         cfde_keywords_merge_agg("at2".synonyms)
       )
      ...
      (SELECT cfde_keywords_merge(
         ...
         cfde_keywords_agg(ff2.id, ff2.name, ff2.description),
         cfde_keywords_merge_agg(ff2.synonyms)
       )
      ...
      (SELECT cfde_keywords_merge(
         ...
         cfde_keywords_agg(dt2.id, dt2.name, dt2.description),
         cfde_keywords_merge_agg(dt2.synonyms)
       )
