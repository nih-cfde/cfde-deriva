...
# HMP ETL data against the C2M2 Level 1 JSON Schema specification prior to submission to CFDE
...
instanceDir=KF_C2M2_submission

schemaFile=C2M2_Level_1.datapackage.json

headerFile=data_validation_report.header

outFile=data_validation_report.KidsFirst.Level_1.txt
